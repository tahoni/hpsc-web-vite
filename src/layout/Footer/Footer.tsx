            ...
            <Row className={classes.FooterInner}>
                <Col xs={{span: 6}} md={{span: 2}} className={layoutClasses.LogoContainer}>
                    <a href={nationalAssociationWebsite} target="_blank">
                        <Image src={nationalAssociationLogo} alt={nationalAssociationAbbreviation + ' logo'} className={`${layoutClasses.Logo} ${layoutClasses.LeftLogo}}`}/>
                    </a>
                </Col>
                ...
                <Col xs={{span: 6}} md={{span: 2, order: 'last'}} className={layoutClasses.LogoContainer}>
                    <a href={internationalAssociationWebsite} target="_blank">
                        <Image src={internationalAssociationLogo} alt={internationalAssociationAbbreviation + ' logo'} className={`${layoutClasses.Logo} ${layoutClasses.RightLogo}`}/>
                    </a>
                </Col>
            </Row>
        </Container>
