export const provincialAssociationName: string = 'North Gauteng Practical Shooting Association';
export const nationalAssociationName: string = 'South African Practical Shooting Association';
export const internationalAssociationName: string = 'International Practical Shooting Confederation';
