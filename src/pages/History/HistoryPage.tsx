...
const HistoryContent = React.lazy(
  () => import("../../content/pages/History/HistoryContent.tsx"),
);
 ...
 *
 * This component is optimized to prevent unnecessary re-renders by using React.memo,
