...
3. **Create the test file co-located with its target**, matching CLAUDE.md's component/layout folder shape and the naming table in `documentation/recommendations/standard-naming.md`:
