...
-   **Club Name**: Displayed prominently in the center.
...
-   **Sidebars**: Optional left and right sidebars used for displaying theme-related images (`ImageSidebar`), enhancing the visual experience of the page.
...
-   **Shooting Ranges**: Details and locations of shooting venues.
...
-   **Styling**: [SCSS (Sass)](https://sass-lang.com/) for custom styles and [Bootstrap 5](https://getbootstrap.com/) for the component framework.
